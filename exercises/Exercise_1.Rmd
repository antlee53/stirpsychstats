...
So, if you wish to select the third element of a list called `this_list`, you would run the following code. You could then run any operations or functions on this object as if it were any ordinary object.
...
So, if you wish to select the third element of a list called `this_vector`, you would run the following code.
...
Simiar to lists and vectors, individual elements of matrices and data.frames can be accessed via indexing. Indexing is the same for both matrices and data.frames. To select an individual element, use the square brackets followed by the row number, then column number, separated by a comma.
