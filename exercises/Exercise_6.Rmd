...
In the data.frame `pain.data`, you've asked participants to rate (on a 5-point scale) how much chronic pain they experience across 5 days. Compute a mean (average) pain rating across the 5 days and test whether this correlates with level of social support. Save the correlation output as `pain.cor`.
